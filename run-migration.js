...
async function runMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'Database', 'migrations', 'create_arbetsorder_table.sql');
    ...
    console.log('📊 Arbetsorder table has been created in the database.');
